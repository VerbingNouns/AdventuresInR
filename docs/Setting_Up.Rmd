...
This is an [R Markdown](http://rmarkdown.rstudio.com) Notebook. If you are reading this on the workshop website, you are looking at the HTML (web) version. Make sure you have the `.Rmd` file as well, which you can download by right-clicking [here](https://github.com/VerbingNouns/AdventuresInR/blob/master/docs/Setting_Up.Rmd) and saving the file to the computer you will be using during the workshop.
...
```{r}
install.packages("tidyverse","lme4","tm","ordinal","SnowballC")
```
