...
2. Press *Ctrl+Alt+I*
3. Just type out the formatting, e.g. three back ticks, curly brackets containing `r`, and three more back ticks to finish the block
...
By far the best way to set the working directory is create and "R Project" in RStudio. When you do this, the RProject stores keeps track of the directory where the files are stored, so there is no need to set the working directory.
